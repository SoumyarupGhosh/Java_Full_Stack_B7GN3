...
public class CustomerAccountTypesInfo {
	...
	@Column(name="customerAcctNum",nullable=false,unique=true)
	...
	@ManyToOne
	//@JoinColumn(name="uci")
	@JoinColumn(name="custAcctNum")
	private CustomerAccount custMapAcctNum; // Not Used so far can be deleted

	public CustomerAccountTypesInfo() {
		
		// TODO Auto-generated constructor stub
	}

	public CustomerAccountTypesInfo(Long custAcctTypeId, String custAcctType, Double monthlyInstallment,
