...
public class RegistrationProcess {
	...
	public RegistrationProcess(Integer regId, String firstname, String lastname, String gender, LocalDate dateOfBirth,
			String emailId, String mobileNum, String address, String city, Integer pinCode, String typeOfAcctHolder,
			List custAcctType, String kycIdentityType, String kycUploadDoc, char kycUploadInd,
			String adminCommentsKYC) {
		super();
		this.regId = regId;
	...
	public List getCustAcctType() {
		return custAcctType;
	}


	public void setCustAcctType(List list) {
		this.custAcctType = list;
	}
